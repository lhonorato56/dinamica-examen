  ...
  lessons: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { t: 'example', title: '📜 Examen anterior · Cilindro en plano inclinado con cuerda y polea — pide las ECUACIONES DE LIGADURA (2025-1)', level: 'dificil',
          body: '<p><b>Examen anterior — Examen FIS1514 1er sem 2025, P1.</b> Enunciado y figura originales del examen (sin modificar). Inténtalo en papel y luego revisa el método.</p><figure class="fig fig-img"><img src="img/ex2025_p1.png" alt="Cilindro en plano inclinado 30 grados con cuerda enrollada que pasa por polea a una masa m colgante" loading="lazy"><figcaption>📷 Examen anterior · Examen FIS1514 1er sem 2025, P1</figcaption></figure>',
          solution: '<div class="steps"><div class="step"><b>Por qué está aquí:</b> el inciso d) pide literalmente "escriba las ecuaciones de ligadura". Es el problema ideal para ver cómo una ligadura conecta varios cuerpos.</div><div class="step"><b>Ligaduras (la clave):</b> (1) el cilindro rueda sin deslizar sobre el plano: $a_{cil}=\alpha_{cil}R$. (2) la cuerda es inextensible: la velocidad con que se desenrolla la cuerda del cilindro es igual a la del bloque $m$. Combinando ambas relacionas $\ddot s$ (bloque) con $\ddot\theta$ (cilindro).</div><div class="step"><b>DCL:</b> cilindro (peso, normal, roce estático, tensión de la cuerda) y bloque $m$ (peso, tensión). Newton traslacional + ecuación de torque $\sum\tau=I\ddot\theta$ con $I=\tfrac12 MR^2$.</div><div class="step"><b>Cierre:</b> usas las ligaduras para eliminar variables y despejas la aceleración del bloque $a$ y la relación $M/m$. (Resultado de la pauta: $M/m=\dfrac{1-2\sin\alpha+4\mu_d\cos\alpha}{\sin\alpha-\mu_d\cos\alpha}$.)</div></div>' }
      ]
    }
  ],
  flashcards: [
  ...
  lessons: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { t: 'example', title: '📜 Examen anterior · Cuerpo que rueda sin deslizar por un plano — esfera vs cilindro vs anillo (2025-1)', level: 'dificil',
          body: '<p><b>Examen anterior — Examen FIS1514 1er sem 2025, P2.</b> Enunciado y figura originales del examen (sin modificar). Inténtalo en papel y luego revisa el método.</p><figure class="fig fig-img"><img src="img/ex2025_p2.png" alt="Cuerpo solido (esfera, cilindro o anillo) que rueda sin deslizar por un plano inclinado de altura h" loading="lazy"><figcaption>📷 Examen anterior · Examen FIS1514 1er sem 2025, P2</figcaption></figure>',
          solution: '<div class="steps"><div class="step"><b>Energía con rodadura:</b> $mgh=\tfrac12 mv^2+\tfrac12 I\omega^2$, con $I=\alpha mR^2$ y rodadura $\omega=v/R$.</div><div class="step">Sustituyendo: $mgh=\tfrac12 mv^2(1+\alpha)\Rightarrow \boxed{v=\sqrt{\dfrac{2gh}{1+\alpha}}}$.</div><div class="step"><b>Comparación:</b> menor $\alpha$ ⇒ mayor $v$. Si solo deslizara (sin rodar) sería $v=\sqrt{2gh}$, siempre mayor (porque rodar gasta energía en rotación).</div><div class="step"><b>Quién llega primero:</b> el de menor $\alpha$ ⇒ la <b>esfera</b> ($\alpha=2/5$) antes que el cilindro ($1/2$) y el anillo ($1$). No depende de la masa ni del radio.</div></div>' },
        { t: 'example', title: '📜 Examen anterior · Bala que se incrusta en un disco con pivote — momentum angular + vuelta completa (2025-1)', level: 'dificil',
          body: '<p><b>Examen anterior — Examen FIS1514 1er sem 2025, P3.</b> Enunciado y figura originales del examen (sin modificar). Inténtalo en papel y luego revisa el método.</p><figure class="fig fig-img"><img src="img/ex2025_p3.png" alt="Disco que cuelga de un pivote O y una bala que impacta horizontalmente y queda incrustada en el borde" loading="lazy"><figcaption>📷 Examen anterior · Examen FIS1514 1er sem 2025, P3</figcaption></figure>',
          solution: '<div class="steps"><div class="step"><b>(a) Inercia del sistema</b> respecto a O: $I=I_{disco}+I_{bala}=\tfrac12 MR^2+m(2R)^2=\left(\tfrac32 M+4m\right)R^2$ (ojo: la bala queda a $2R$ de O).</div><div class="step"><b>(b) Choque (momentum angular respecto a O):</b> $m\,v\,(2R)=I\,\omega\Rightarrow \omega=\dfrac{2mvR}{I}$. (La energía NO se conserva: la bala se incrusta.)</div><div class="step"><b>(c) Vuelta completa:</b> después del choque conserva energía; impón que llegue al punto más alto con la rapidez mínima. Energía: $\tfrac12 I\omega^2=\Delta U$ del centro de masa del sistema al subir. Despejas el $v$ mínimo.</div><div class="step"><b>(d) Aceleración angular</b> en un ángulo dado: $\ddot\theta=\dfrac{\tau_{peso}}{I}=\dfrac{(M+m)g\,d_{CM}\sin\phi}{I}$, con $d_{CM}$ la distancia de O al centro de masa del sistema.</div></div>' }
      ]
    }
  ],
  flashcards: [
